    ...
    <div x-show="open">
        ...
        >
            ...
            <button
                type="button"
                @click="closeSheet()"
                class="absolute rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none p-1 @if(in_array($side, ['top', 'bottom'])) right-4 top-4 @else right-4 top-4 @endif"
            >
